      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Use these when writing website copy, meta descriptions, headings, and Google Business posts.
          </p>
        </div>
        <div className="flex items-center gap-2">
          {keywords.length > 0 && (
      ...
      {keywords.length === 0 ? (
        <div className="bg-gray-50 rounded-xl border border-dashed border-gray-300 p-10 text-center">
          ...
          <p className="text-gray-400 text-xs">
            Click "Generate Keywords" — uses business info, description, and review content.
          </p>
        </div>
      ) : (
        <>
          <div className="flex flex-wrap gap-2">
            {keywords.map((k: string) => (
              <span
                key={k}
                className="bg-blue-50 border border-blue-200 text-blue-800 px-3 py-1 rounded-full text-sm font-medium"
              >
                {k}
              </span>
            ))}
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <p className="text-xs text-gray-500 mb-1 font-medium">Comma-separated (for copy-paste into prompts)</p>
...
// Main detail page
// ---------------------------------------------------------------------------
const TABS = ['Overview', 'Keywords', 'Insights', 'Website', 'CRM', 'Deployment'] as const
